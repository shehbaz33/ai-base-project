...
def process_and_save_apollo_results(db: Session, results: list, entity_type_hint: str = None):
    """
    ...
    for result in results:
        ...
        print(existing_source,'existing_source')
        ...
        if existing_source:
            ...
            saved_entities.append(existing_source.entity)
            continue
